...
.btn-check:focus + .btn-primary, .btn-primary:focus {
  ...
  /* background-color: #cf5331;
  border-color: #c34e2e; */
  background-color: #6b8516;
  border-color: #6b8516;
  box-shadow: 0 0 0 0.25rem rgba(96, 119, 19, 0.5);
}
...
.navbar-expand-lg .offcanvas-bottom {
  ...
  .logo{
    background-image: url(../assets/img/logos/logo_white_80.png);
    background-repeat: no-repeat;
    background-size: 172px 81px;
    height: 81px;
    margin-left: 150px;
  }
}
...
.text-primary {
  ...
  color: rgba(var(--bs-primary-rgb2), var(--bs-text-opacity)) !important;
}
...
@media (min-width: 992px) {
  ...
  #mainNav.navbar-shrink .logo{
    background-image: url(../assets/img/logos/logo_black_80.png);
    background-repeat: no-repeat;
    background-size: 172px 81px;
    height: 80px;
  }

  #mainNav.navbar-shrink .st{
    margin-left: 40px;
  }
}
...
@media(max-width: 990px){
  #mainNav .logo{
    background-image: url(../assets/img/logos/logo_black_60.png);
    background-repeat: no-repeat;
